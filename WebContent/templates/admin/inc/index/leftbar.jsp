...
<link
	href="<%=request.getContextPath()%>/templates/admin/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css"
	rel="stylesheet">
<!-- JQVMap -->
<link
	href="<%=request.getContextPath()%>/templates/admin/vendors/jqvmap/dist/jqvmap.min.css"
	rel="stylesheet" />
...
<link
	...
	rel="stylesheet">
<link
	href="<%=request.getContextPath()%>/templates/admin/build/css/switch.css"
	rel="stylesheet">
<script
...
<%
	User userGet1 = (User) session.getAttribute("userLogin");
%>
<body class="nav-md">
				...
				<div class="left_col scroll-view">
					...
					<div class="sidebar-footer hidden-small">
						   <a data-toggle="tooltip" data-placement="top" title="Logout"
							href="<%=request.getContextPath()%>/auth/logout"> <span class="glyphicon glyphicon-off"
